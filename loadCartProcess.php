...
INNER JOIN `product` ON `stock`.`product_id` = `product`.`product_id` INNER JOIN `color` ON `product`.`color_id` = `color`.`color_id` 
...
?>
    ...
    ?>
        ...
        <!-- Cart Item -->
        <div style="backdrop-filter: blur(10px);" class="col-12 border border-3 rounded-5 p-3 mb-2 d-flex justify-content-between  " style="color: orange;">
            

                <div class="d-flex align-items-center col-5">
                    <img src="<?php echo $d["img"] ?>" class="rounded-4" width="200px" />
                    <div class="ms-5">
                        <h4><?php echo $d["name"] ?></h4>
                        <p class="text-muted  mt-2">Color: <?php echo $d["color_name"] ?></p>
            ...
            <div class="d-flex align-items-end mb-lg-10">
