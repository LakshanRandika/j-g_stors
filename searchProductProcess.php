...
$q = "SELECT * FROM `stock` INNER JOIN `product` ON `stock`.`stock_id` = `product`.`product_id` WHERE `product`.`name` LIKE '%$product%'";
...
?>
    ...
    ?>
        ...
        <div class=" col-3 mt-5 d-flex justify-content-center">
            ...
            <a href="singleProductView.php?s=<?php echo $d["stock_id"] ?>"><img src="<?php echo $d["img"] ?>" class="card-img-top"></a>
                <div class="card-body">
